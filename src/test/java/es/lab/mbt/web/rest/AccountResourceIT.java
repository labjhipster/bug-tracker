package es.lab.mbt.web.rest;

import es.lab.mbt.MbtApp;
import es.lab.mbt.config.Constants;
import es.lab.mbt.domain.User;
import es.lab.mbt.repository.AuthorityRepository;
import es.lab.mbt.repository.UserRepository;
import es.lab.mbt.security.AuthoritiesConstants;
import es.lab.mbt.service.UserService;
import es.lab.mbt.service.dto.PasswordChangeDTO;
import es.lab.mbt.service.dto.UserDTO;
import es.lab.mbt.web.rest.vm.KeyAndPasswordVM;
import es.lab.mbt.web.rest.vm.ManagedUserVM;
...
import static es.lab.mbt.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = MbtApp.class)
