...
import es.lab.mbt.config.audit.AuditEventConverter;
import es.lab.mbt.domain.PersistentAuditEvent;
import es.lab.mbt.repository.PersistenceAuditEventRepository;
import es.lab.mbt.security.AuthoritiesConstants;

import es.lab.mbt.service.AuditEventService;
